...
module.exports = async function (deployer, _network, accounts) {
	await deployer.ens.setAddress("alice.name", accounts[0], {
		from: accounts[0],
	})
	await deployer.ens.setAddress("donald.name", accounts[1], {
		from: accounts[0],
	})
	...
	// User 2
	await tweeter.tweet("I want to make America great again!", {
		from: "donald.name",
	})
